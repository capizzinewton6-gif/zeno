...
@dataclass
class CpuMonitoringConfig:
    """Configuration for cpu_monitoring."""
    enabled: bool = True
    timeout: int = 30
...
class CpuMonitoring:
    """
    cpu_monitoring Capability Module.
    ...
    def __init__(self, config: Optional[CpuMonitoringConfig] = None):
        """
        Initialize cpu_monitoring.
        
        Args:
            config: Module configuration
        """
        self.config = config or CpuMonitoringConfig()
        logger.info("cpu_monitoring initialized")
    ...
    def get_capability_description(self) -> str:
        ...
        return "CPU usage and performance monitoring"
