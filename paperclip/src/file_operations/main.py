...
class FileOperationsConfig:
    """Configuration for file_operations."""
    enabled: bool = True
    timeout: int = 30
...
class FileOperations:
    """
    file_operations Capability Module.
    ...
    def __init__(self, config: Optional[FileOperationsConfig] = None):
        ...
        logger.info("file_operations initialized")
    ...
    def get_capability_description(self) -> str:
        ...
        return "Copy, move, rename, and delete files"
