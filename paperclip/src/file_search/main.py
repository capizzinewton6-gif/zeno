...
class FileSearch:
    ...
    def __init__(self, config: Optional[FileSearchConfig] = None):
        ...
        logger.info("file_search initialized")
    ...
    def get_capability_description(self) -> str:
        ...
        return "Intelligent file searching by name and content"
