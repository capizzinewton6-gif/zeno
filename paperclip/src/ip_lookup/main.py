...
class IpLookup:
    ...
    def __init__(self, config: Optional[IpLookupConfig] = None):
        """
        Initialize ip_lookup.
        
        Args:
            config: Module configuration
        """
        self.config = config or IpLookupConfig()
        logger.info("ip_lookup initialized")
    ...
    def get_capability_description(self) -> str:
        ...
        return "IP address lookup and geolocation"
