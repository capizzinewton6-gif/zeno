...
class MediaDownloadConfig:
    """Configuration for media_download."""
    enabled: bool = True
    timeout: int = 30
...
class MediaDownload:
    """
    media_download Capability Module.
    ...
    def __init__(self, config: Optional[MediaDownloadConfig] = None):
        """
        Initialize media_download.
        
        Args:
            config: Module configuration
        """
        self.config = config or MediaDownloadConfig()
        logger.info("media_download initialized")
