"""
interaction - object_deformation
========================================
Interactive object deformation.
...
class ObjectDeformation:
    """Interactive object deformation."""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "object_deformation"
        self.description = "Interactive object deformation."
